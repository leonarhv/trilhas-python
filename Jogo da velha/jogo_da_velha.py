...
def boas_vindas(stdscr):
    ...
    stdscr.addstr(16, 1, "Desenvolvido originalmente por: E. S. Pereira.")
    stdscr.addstr(17, 1, "Editado para estudos por: Leonardo H Vieira")
    stdscr.addstr(18, 1, "Licensa Nova BSD.")


def ajuda(stdscr):
    stdscr.clear()
    stdscr.border()
    stdscr.addstr(1, 1, "Pressione Q para sair ou H para exibir essa janela de ajuda")
    stdscr.addstr(2, 1, "Para mudar de posição, use as teclas: W, A, S, D")
